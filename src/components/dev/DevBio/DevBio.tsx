...
export default function DevBio(): JSX.Element {
  return (
    <Typography>
      ...
      <br />
      <br />I started by learning C# to implement audio in video games, but quickly discovered a love for programming on its own. I taught myself the basics of web development through online resources and completed a full-stack bootcamp course that covered HTML, CSS, JavaScript, Node, Express, and MongoDB. From there, I decided to focus on mobile app development and enrolled in a course on React and React Native.
      <br />
      <br />As an avid backpacker, I created my first solo app, Trail Pack Pro, a React Native app that inventories and manages camping equipment. This experience led to a job at Nomi Travel, where I currently work on two React web-apps and their backend APIs using Node, Express, and MongoDB.
      <br />
      <br />I am a self-motivated learner who is always seeking out new challenges. I have a library of hundreds of hours of online course content and am constantly working on at least one course at a time. With my attention to detail, problem-solving skills, and passion for learning, I am excited to bring my unique background and experience to a software development role.
    </Typography>
  );
};
